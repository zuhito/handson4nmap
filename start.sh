...
pgrep -f openvpn-udp.conf > /dev/null || setsid nohup openvpn --config openvpn-udp.conf < /dev/null > /tmp/openvpn-udp.log 2>&1 &
pgrep -f openvpn-tcp.conf > /dev/null || setsid nohup openvpn --config openvpn-tcp.conf < /dev/null > /tmp/openvpn-tcp.log 2>&1 &
