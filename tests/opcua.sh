...
timeout 60 bash -c 'until : > /dev/tcp/127.0.0.1/4855; do sleep 1; done' 2>/dev/null

sed 's/{4840, 4841, 48010, 53530}/{4840,4851,4852,4853,4854,4855}/' opcua.nse > /tmp/opcua-variants.nse
